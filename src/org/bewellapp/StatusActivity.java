...
public class StatusActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		wifi_level_Tv.setText(appState.infoObj.wifi_status.toString());
		...
		url_Status = (TextView) findViewById(R.id.url_upload_status);
		url_Status.setText(appState.WebServiceURL);
